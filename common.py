...
AV_STATUS_INFECTED_ALLOWED = os.getenv("AV_STATUS_INFECTED_ALLOWED", "INFECTED ALLOW")
AV_STATUS_UNSCANABLE = os.getenv("AV_STATUS_UNSCANABLE", "UNSCANABLE")
AV_STATUS_ERROR = os.getenv("AV_STATUS_ERROR", "ERROR")
AV_SCANNED_MESSAGE = os.getenv("AV_SCANNED_MESSAGE", "av-message")
